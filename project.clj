(defproject weight_analyzer "0.1.0-SNAPSHOT"

  :description "Analyzes your weight"
  :url "http://weightanalyzer.gleenn.com"
  ...
  :main ^:skip-aot weight-analyzer.core
  ...
  {:nrepl {:port 7002}
   ...
   {:app
    {:target :browser
     ...
     :asset-path "/js"
     :modules {:app {:entries [weight-analyzer.app]}}
     :devtools
  ...
  {:uberjar {:omit-source true
             ...
             :aot :all
             :uberjar-name "weight_analyzer.jar"
